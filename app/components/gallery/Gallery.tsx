  ...
  return (
    ...
    >
      <div className="mx-auto max-w-7xl px-4 sm:px-6">
        ...
        >
          <h2 className="text-4xl font-black text-yellow-400 sm:text-5xl">
            معرض الصور
          </h2>
        ...
        <div className="mt-10 flex flex-wrap justify-center gap-3 sm:mt-12">
          {branches.map((branch, index) => {
            const isActive = branchIndex === index;
        ...
        >
          {images.map((image, index) => (
            <button
              ...
              aria-label={`فتح صورة ${index + 1} - ${currentBranch.name}`}
              className="
                group
                relative
                overflow-hidden
            ...
            >
              <div className="relative aspect-7/5 w-full">
                ...
                <Image
                  src={image}
                  alt={`${currentBranch.name} - صورة ${index + 1}`}
                  fill
                  sizes="
        ...
        {selectedIndex !== null &&
          images[selectedIndex] && (
            <motion.div
              ...
              role="dialog"
              aria-modal="true"
              aria-label={`عرض صور ${currentBranch.name}`}
            >
              {/* زر الإغلاق */}
